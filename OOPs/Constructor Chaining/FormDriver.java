class FormDriver 
{
	...
	{
		this(name,age,percentage,Email,degree,aggregate,mono);
	...
	{
		this(name,age,percentage,Email,degree,aggregate,mono,blood);
		this.ht=ht;
	}
	...
	{
		this(name,age,percentage,Email,degree,aggregate,mono,blood,ht);
		weight=wt;
	}
